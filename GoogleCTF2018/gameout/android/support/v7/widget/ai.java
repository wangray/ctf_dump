...
public class ai extends ViewGroup {
    ...
    void a(int i, int i2) {
        ...
        while (i13 < virtualChildCount) {
            ...
            if (b2 == null) {
                ...
                if (i13 >= i11 || aVar.g <= 0.0f) {
                    ...
                    i7 = Math.max(i7, i5);
                    int combineMeasuredStates = View.combineMeasuredStates(i8, b2.getMeasuredState());
                    obj = (obj2 == null || aVar.width != -1) ? null : 1;
                    if (aVar.g > 0.0f) {
                        i3 = Math.max(i10, obj7 != null ? i4 : i5);
                        i4 = i9;
                    } else {
                        if (obj7 == null) {
                            i4 = i5;
        ...
        i6 = (16777215 & resolveSizeAndState) - this.f;
        int i17;
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(i3 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, i8), resolveSizeAndState);
        if (obj3 != null) {
    ...
    void b(int i, int i2) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (b == null) {
                ...
                int combineMeasuredStates = View.combineMeasuredStates(i8, b.getMeasuredState());
                if (z) {
                    i8 = b.getBaseline();
                    if (i8 != -1) {
                        int i15 = ((((aVar2.h < 0 ? this.e : aVar2.h) & j.AppCompatTheme_windowFixedHeightMajor) >> 4) & -2) >> 1;
            ...
            while (i11 < virtualChildCount) {
                ...
                if (b3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        i10 = View.combineMeasuredStates(i15, b3.getMeasuredState() & -16777216);
                        f5 = f3;
                    } else {
                        i4 = i14;
                        i10 = i15;
        ...
        setMeasuredDimension((-16777216 & i8) | resolveSizeAndState, View.resolveSizeAndState(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i8 << 16));
        if (obj2 != null) {
