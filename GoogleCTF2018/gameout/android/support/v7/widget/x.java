...
public class x extends Spinner implements o {
    ...
    public x(Context context, AttributeSet attributeSet, int i, int i2, Theme theme) {
        ...
        super(context, attributeSet, i);
        this.i = new Rect();
        aw a = aw.a(context, attributeSet, j.Spinner, i, 0);
        this.b = new g(this);
        if (theme != null) {
            this.c = new d(context, theme);
        } else {
            int g = a.g(j.Spinner_popupTheme, 0);
            if (g != 0) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == 1) {
                                    ...
                                    a2 = aw.a(this.c, attributeSet, j.Spinner, i, 0);
                                    this.h = a2.f(j.Spinner_android_dropDownWidth, -2);
                                    bVar.a(a2.a(j.Spinner_android_popupBackground));
                                    bVar.a(a.d(j.Spinner_android_prompt));
                                    a2.a();
                                    this.g = bVar;
                                ...
                                f = a.f(j.Spinner_android_entries);
                                if (f != null) {
