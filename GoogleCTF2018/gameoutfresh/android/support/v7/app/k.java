        ...
        if (obtainStyledAttributes.hasValue(j.AppCompatTheme_windowActionBar)) {
            ...
            if (this.l) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ...
                    ((ag) view2).setOnFitSystemWindowsListener(new android.support.v7.widget.ag.a(this) {
                        final /* synthetic */ k a;
                ...
                this.u = (ac) r0.findViewById(android.support.v7.a.a.f.decor_content_parent);
