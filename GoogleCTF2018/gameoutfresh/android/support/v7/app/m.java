...
class m {
    ...
    private void a(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || p.n(view)) {
    ...
    public final View a(View view, String str, Context context, AttributeSet attributeSet, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        switch (obj) {
            case null:
                ...
                break;
            case 1:
                view2 = new android.support.v7.widget.p(context2, attributeSet);
                break;
            case 2:
                view2 = new h(context2, attributeSet);
                break;
            case 3:
                view2 = new android.support.v7.widget.m(context2, attributeSet);
                break;
            case 4:
                view2 = new x(context2, attributeSet);
                break;
            case 5:
            ...
            case 6:
                ...
                break;
            case 7:
                view2 = new t(context2, attributeSet);
                break;
            case 8:
                view2 = new android.support.v7.widget.j(context2, attributeSet);
                break;
            case 9:
                view2 = new f(context2, attributeSet);
                break;
            case 10:
                view2 = new q(context2, attributeSet);
                break;
            case 11:
