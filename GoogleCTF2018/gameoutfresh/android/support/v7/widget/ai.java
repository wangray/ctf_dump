...
public class ai extends ViewGroup {
    ...
    void b(int i, int i2) {
        ...
        if (z2 && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            while (i5 < virtualChildCount) {
                ...
                if (b2 == null) {
                    ...
                    if (obj5 != null) {
                        this.f = ((aVar.rightMargin + (aVar.leftMargin + i10)) + b(b2)) + this.f;
                        i3 = i5;
                    } else {
                        i4 = this.f;
                        this.f = Math.max(i4, (aVar.rightMargin + ((i4 + i10) + aVar.leftMargin)) + b(b2));
                        i3 = i5;
                    }
                }
                i5 = i3 + 1;
        ...
        i5 = (16777215 & resolveSizeAndState) - this.f;
        int i16;
            ...
            while (i10 < virtualChildCount) {
                ...
                if (b3 == null) {
                    ...
                    if (obj5 != null) {
                        ...
                        i5 = this.f;
                        this.f = Math.max(i5, (((b3.getMeasuredWidth() + i5) + aVar.leftMargin) + aVar.rightMargin) + b(b3));
                    }
