...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/ao;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Landroid/support/design/a$j;->ForegroundLinearLayout:[I

    invoke-virtual {p1, p2, v0, p3, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v0

    sget v1, Landroid/support/design/a$j;->ForegroundLinearLayout_android_foregroundGravity:I
    ...
    sget v1, Landroid/support/design/a$j;->ForegroundLinearLayout_android_foreground:I
    ...
    :cond_0
    sget v1, Landroid/support/design/a$j;->ForegroundLinearLayout_foregroundInsidePadding:I
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/ao;->draw(Landroid/graphics/Canvas;)V
...
.method public drawableHotspotChanged(FF)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/ao;->drawableHotspotChanged(FF)V
...
.method protected drawableStateChanged()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/ao;->drawableStateChanged()V
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/ao;->jumpDrawablesToCurrentState()V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/ao;->onSizeChanged(IIII)V
...
.method protected verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/ao;->verifyDrawable(Landroid/graphics/drawable/Drawable;)Z
