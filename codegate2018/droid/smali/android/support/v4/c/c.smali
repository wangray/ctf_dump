...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/c/c;->b:Landroid/support/v4/h/g;
...
.method public static a(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
    ...
    sget-object v1, Landroid/support/v4/c/c;->b:Landroid/support/v4/h/g;

    invoke-static {p1, p2, p4}, Landroid/support/v4/c/c;->b(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, v0}, Landroid/support/v4/h/g;->a(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    return-object v0
.end method

.method public static a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
    .locals 1

    sget-object v0, Landroid/support/v4/c/c;->a:Landroid/support/v4/c/c$a;

    invoke-interface {v0, p0, p1, p2, p3}, Landroid/support/v4/c/c$a;->a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/Context;Landroid/support/v4/b/a/a$a;Landroid/content/res/Resources;IILandroid/widget/TextView;)Landroid/graphics/Typeface;
    ...
    invoke-virtual {p1}, Landroid/support/v4/b/a/a$d;->a()Landroid/support/v4/g/a;
    ...
    invoke-static/range {v0 .. v5}, Landroid/support/v4/g/b;->a(Landroid/content/Context;Landroid/support/v4/g/a;Landroid/widget/TextView;III)Landroid/graphics/Typeface;
...
.method public static a(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    sget-object v0, Landroid/support/v4/c/c;->b:Landroid/support/v4/h/g;

    invoke-static {p0, p1, p2}, Landroid/support/v4/c/c;->b(Landroid/content/res/Resources;II)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/support/v4/h/g;->a(Ljava/lang/Object;)Ljava/lang/Object;
