...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
    ...
    new-instance v3, Landroid/support/v4/h/m;

    invoke-direct {v3}, Landroid/support/v4/h/m;-><init>()V
    ...
    invoke-virtual {v5}, Landroid/support/v4/g/b$b;->a()Landroid/net/Uri;

    move-result-object v6

    invoke-virtual {v3, v6}, Landroid/support/v4/h/m;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v6, v0}, Landroid/support/v4/h/m;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    invoke-virtual {v5}, Landroid/support/v4/g/b$b;->b()I

    move-result v6

    invoke-virtual {v5}, Landroid/support/v4/g/b$b;->c()I

    move-result v7

    invoke-virtual {v5}, Landroid/support/v4/g/b$b;->d()Z
