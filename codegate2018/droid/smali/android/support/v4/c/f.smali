...
.method public a(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroid/support/v4/g/b$b;I)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-virtual {p0, p3, p4}, Landroid/support/v4/c/f;->a([Landroid/support/v4/g/b$b;I)Landroid/support/v4/g/b$b;
    ...
    :try_start_0
    invoke-virtual {v0}, Landroid/support/v4/g/b$b;->a()Landroid/net/Uri;
    ...
    invoke-virtual {v0}, Landroid/support/v4/g/b$b;->c()I
    ...
    invoke-virtual {v0}, Landroid/support/v4/g/b$b;->d()Z
    ...
    :cond_5
    invoke-static {p1, p3, p2}, Landroid/support/v4/g/b;->a(Landroid/content/Context;[Landroid/support/v4/g/b$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    invoke-virtual {v6}, Landroid/support/v4/g/b$b;->a()Landroid/net/Uri;
    ...
    :cond_6
    invoke-virtual {v6}, Landroid/support/v4/g/b$b;->b()I

    move-result v7

    invoke-virtual {v6}, Landroid/support/v4/g/b$b;->c()I

    move-result v8

    invoke-virtual {v6}, Landroid/support/v4/g/b$b;->d()Z
