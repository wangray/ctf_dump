...
.method private constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/support/v4/widget/n$a;)V
    ...
    iput-object p3, p0, Landroid/support/v4/widget/n;->r:Landroid/support/v4/widget/n$a;
    ...
    iput v1, p0, Landroid/support/v4/widget/n;->m:F
    ...
    iput v0, p0, Landroid/support/v4/widget/n;->n:F
    ...
    iput-object v0, p0, Landroid/support/v4/widget/n;->q:Landroid/widget/OverScroller;
...
.method private a(III)I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/widget/n;->a(F)F
...
.method private a(Landroid/view/View;IIII)I
    ...
    iget v0, p0, Landroid/support/v4/widget/n;->n:F

    float-to-int v0, v0

    iget v1, p0, Landroid/support/v4/widget/n;->m:F

    float-to-int v1, v1

    invoke-direct {p0, p4, v0, v1}, Landroid/support/v4/widget/n;->b(III)I
    ...
    invoke-direct {p0, p5, v0, v1}, Landroid/support/v4/widget/n;->b(III)I
    ...
    invoke-virtual {v4, p1}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;)I

    move-result v4

    invoke-direct {p0, p2, v2, v4}, Landroid/support/v4/widget/n;->a(III)I

    move-result v2

    iget-object v4, p0, Landroid/support/v4/widget/n;->r:Landroid/support/v4/widget/n$a;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;)I

    move-result v4

    invoke-direct {p0, p3, v3, v4}, Landroid/support/v4/widget/n;->a(III)I
...
.method private a(FF)V
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/n;->b(I)V
...
.method private a(FFI)V
    ...
    invoke-direct {p0, p3}, Landroid/support/v4/widget/n;->d(I)V

    iget-object v0, p0, Landroid/support/v4/widget/n;->d:[F

    iget-object v1, p0, Landroid/support/v4/widget/n;->f:[F
    ...
    iget-object v1, p0, Landroid/support/v4/widget/n;->g:[F
    ...
    invoke-direct {p0, v1, v2}, Landroid/support/v4/widget/n;->d(II)I
...
.method private a(FFII)Z
    ...
    invoke-virtual {v2, p4}, Landroid/support/v4/widget/n$a;->b(I)Z
...
.method private a(IIII)Z
    ...
    iget-object v1, p0, Landroid/support/v4/widget/n;->q:Landroid/widget/OverScroller;

    invoke-virtual {v1}, Landroid/widget/OverScroller;->abortAnimation()V

    invoke-virtual {p0, v0}, Landroid/support/v4/widget/n;->b(I)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v4/widget/n;->a(Landroid/view/View;IIII)I

    move-result v9

    iget-object v4, p0, Landroid/support/v4/widget/n;->q:Landroid/widget/OverScroller;
...
.method private a(Landroid/view/View;FF)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;)I
...
.method private b(FFI)V
    ...
    invoke-virtual {v1, v0, p3}, Landroid/support/v4/widget/n$a;->b(II)V
...
.method private b(IIII)V
    ...
    invoke-virtual {v2, v3, p1, p3}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;II)I
    ...
    invoke-static {v3, v4}, Landroid/support/v4/i/q;->d(Landroid/view/View;I)V
    ...
    invoke-virtual {v3, v4, p2, p4}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;II)I
    ...
    invoke-static {v4, v5}, Landroid/support/v4/i/q;->c(Landroid/view/View;I)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;IIII)V
...
.method private d(II)I
    ...
    iget v2, p0, Landroid/support/v4/widget/n;->o:I
...
.method private d()V
    ...
    invoke-direct {p0, v0, v1, v2}, Landroid/support/v4/widget/n;->a(FFF)F
    ...
    invoke-direct {p0, v1, v2, v3}, Landroid/support/v4/widget/n;->a(FFF)F
...
.method private d(I)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/n;->g:[F
    ...
    iget-object v7, p0, Landroid/support/v4/widget/n;->h:[I

    iget-object v8, p0, Landroid/support/v4/widget/n;->h:[I

    array-length v8, v8

    invoke-static {v7, v9, v4, v9, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v7, p0, Landroid/support/v4/widget/n;->i:[I

    iget-object v8, p0, Landroid/support/v4/widget/n;->i:[I

    array-length v8, v8

    invoke-static {v7, v9, v5, v9, v8}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v7, p0, Landroid/support/v4/widget/n;->j:[I

    iget-object v8, p0, Landroid/support/v4/widget/n;->j:[I
    ...
    :cond_1
    iput-object v0, p0, Landroid/support/v4/widget/n;->d:[F

    iput-object v1, p0, Landroid/support/v4/widget/n;->e:[F

    iput-object v2, p0, Landroid/support/v4/widget/n;->f:[F

    iput-object v3, p0, Landroid/support/v4/widget/n;->g:[F

    iput-object v4, p0, Landroid/support/v4/widget/n;->h:[I

    iput-object v5, p0, Landroid/support/v4/widget/n;->i:[I

    iput-object v6, p0, Landroid/support/v4/widget/n;->j:[I
...
.method public a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;I)V
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v2, p0, Landroid/support/v4/widget/n;->l:Landroid/view/VelocityTracker;
    ...
    iput-object v2, p0, Landroid/support/v4/widget/n;->l:Landroid/view/VelocityTracker;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/widget/n$a;->a(II)V
    ...
    iget v2, p0, Landroid/support/v4/widget/n;->p:I
    ...
    invoke-virtual {v2, v1, v0}, Landroid/support/v4/widget/n$a;->a(II)V
    ...
    invoke-virtual {p0, v2, v1}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v0}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
    ...
    invoke-direct {p0, v3}, Landroid/support/v4/widget/n;->e(I)Z
    ...
    invoke-virtual {p0, v0, v4}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;
    ...
    iget-object v9, p0, Landroid/support/v4/widget/n;->r:Landroid/support/v4/widget/n$a;

    float-to-int v10, v5

    invoke-virtual {v9, v4, v8, v10}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;II)I
    ...
    invoke-virtual {v11, v4, v10, v12}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;II)I

    move-result v10

    iget-object v11, p0, Landroid/support/v4/widget/n;->r:Landroid/support/v4/widget/n$a;

    invoke-virtual {v11, v4}, Landroid/support/v4/widget/n$a;->b(Landroid/view/View;)I

    move-result v11

    iget-object v12, p0, Landroid/support/v4/widget/n;->r:Landroid/support/v4/widget/n$a;

    invoke-virtual {v12, v4}, Landroid/support/v4/widget/n$a;->a(Landroid/view/View;)I
    ...
    invoke-virtual {p0, v4, v3}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
...
.method public a(Z)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/n;->q:Landroid/widget/OverScroller;
    ...
    invoke-static {v0, v4}, Landroid/support/v4/i/q;->d(Landroid/view/View;I)V
    ...
    invoke-static {v0, v5}, Landroid/support/v4/i/q;->c(Landroid/view/View;I)V
    ...
    :cond_5
    invoke-virtual {p0, v6}, Landroid/support/v4/widget/n;->b(I)V
...
.method public b(Landroid/view/MotionEvent;)V
    ...
    invoke-virtual {p0, v3, v4}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;

    move-result-object v3

    invoke-direct {p0, v1, v2, v0}, Landroid/support/v4/widget/n;->a(FFI)V

    invoke-virtual {p0, v3, v0}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Landroid/support/v4/widget/n;->b(II)Z
    ...
    invoke-direct {p0, v2, v3, v1, v0}, Landroid/support/v4/widget/n;->b(IIII)V
    ...
    invoke-direct {p0, v3, v5, v6}, Landroid/support/v4/widget/n;->a(Landroid/view/View;FF)Z

    move-result v4

    if-eqz v4, :cond_5

    invoke-virtual {p0, v3, v2}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
    ...
    invoke-virtual {p0, v5, v6}, Landroid/support/v4/widget/n;->c(II)Landroid/view/View;
    ...
    invoke-virtual {p0, v5, v4}, Landroid/support/v4/widget/n;->b(Landroid/view/View;I)Z
    ...
    :cond_b
    invoke-direct {p0, v2}, Landroid/support/v4/widget/n;->c(I)V
    ...
    invoke-direct {p0, v5, v5}, Landroid/support/v4/widget/n;->a(FF)V
...
.method public b(II)Z
    ...
    invoke-virtual {p0, v0, p1, p2}, Landroid/support/v4/widget/n;->b(Landroid/view/View;II)Z
...
.method public c(II)Landroid/view/View;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/widget/n$a;->c(I)I
