...
.field q:Landroid/support/v4/i/t;

.field r:Z

.field s:I

.field private u:Landroid/support/v7/widget/ae;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/d;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/i/t;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ae;
    ...
    iget-object v1, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ae;
...
.method private b(Landroid/support/v7/app/k$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ae;
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/k;->u:Landroid/support/v7/widget/ae;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/i/q;->a(Landroid/view/View;Landroid/support/v4/i/o;)V
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/ak;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/ak$a;)V
    ...
    :cond_e
    invoke-static {v2}, Landroid/support/v7/widget/bq;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    invoke-virtual {v0, v7}, Landroid/support/v4/i/t;->a(F)Landroid/support/v4/i/t;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/i/t;

    iget-object v0, p0, Landroid/support/v7/app/k;->q:Landroid/support/v4/i/t;
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    :cond_1
    iput-object v2, p0, Landroid/support/v7/app/k;->g:Landroid/view/MenuInflater;
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/o;->h()Landroid/view/Window$Callback;
    ...
    :goto_1
    invoke-virtual {p0}, Landroid/support/v7/app/k;->f()V

    goto :goto_0

    :cond_3
    iput-object v2, p0, Landroid/support/v7/app/k;->f:Landroid/support/v7/app/a;

    iget-object v0, p0, Landroid/support/v7/app/k;->b:Landroid/view/Window;

    iget-object v1, p0, Landroid/support/v7/app/k;->d:Landroid/view/Window$Callback;
...
.method g(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/widget/bq;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public h()V
    ...
    invoke-static {v0, p0}, Landroid/support/v4/i/e;->b(Landroid/view/LayoutInflater;Landroid/view/LayoutInflater$Factory2;)V
...
.method t()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/i/t;->b()V
