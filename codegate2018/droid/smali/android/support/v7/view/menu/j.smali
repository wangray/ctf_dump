...
.field private B:Landroid/support/v4/i/c;
...
.method public a(Landroid/support/v4/i/c;)Landroid/support/v4/d/a/b;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    invoke-virtual {v0}, Landroid/support/v4/i/c;->f()V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/i/c;->a(Landroid/support/v4/i/c$b;)V
...
.method public a(Landroid/view/View;)Landroid/support/v4/d/a/b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;
...
.method public a()Landroid/support/v4/i/c;
    .locals 1
...
.method public b()Z
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    if-eqz v1, :cond_4

    iget-object v1, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    invoke-virtual {v1}, Landroid/support/v4/i/c;->d()Z
...
.method public isVisible()Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/support/v7/view/menu/j;->B:Landroid/support/v4/i/c;

    invoke-virtual {v2}, Landroid/support/v4/i/c;->b()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/i/c;->c()Z
...
.method public n()Z
    ...
    invoke-virtual {v1, p0}, Landroid/support/v4/i/c;->a(Landroid/view/MenuItem;)Landroid/view/View;
