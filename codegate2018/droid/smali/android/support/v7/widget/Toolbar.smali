...
.field private u:Landroid/support/v7/widget/ay;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;

    move-result-object v1

    sget v0, Landroid/support/v7/a/a$j;->Toolbar_titleTextAppearance:I

    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/bi;->g(II)I
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/widget/bi;->c(II)I
    ...
    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/bi;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/a/a$j;->Toolbar_titleMargins:I

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/bi;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bi;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bi;->e(II)I
    ...
    invoke-virtual {v1, v0, v8}, Landroid/support/v7/widget/bi;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/a/a$j;->Toolbar_contentInsetEnd:I

    invoke-virtual {v1, v2, v8}, Landroid/support/v7/widget/bi;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$j;->Toolbar_contentInsetLeft:I

    invoke-virtual {v1, v3, v7}, Landroid/support/v7/widget/bi;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/a/a$j;->Toolbar_contentInsetRight:I

    invoke-virtual {v1, v4, v7}, Landroid/support/v7/widget/bi;->e(II)I

    move-result v4

    invoke-direct {p0}, Landroid/support/v7/widget/Toolbar;->s()V

    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ay;
    ...
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ay;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/bi;->b(II)I
...
.method private a(Ljava/util/List;I)V
    ...
    invoke-static {p2, v3}, Landroid/support/v4/i/d;->a(II)I
...
.method private b(I)I
    ...
    invoke-static {p1, v1}, Landroid/support/v4/i/d;->a(II)I
...
.method private b(Landroid/view/View;)I
    ...
    invoke-static {v0}, Landroid/support/v4/i/f;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v1

    invoke-static {v0}, Landroid/support/v4/i/f;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private s()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ay;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ay;
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ay;->a(II)V
...
.method public getWrapper()Landroid/support/v7/widget/af;
    .locals 2
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Landroid/support/v4/i/q;->i(Landroid/view/View;)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ay;

    if-ne p1, v0, :cond_1

    :goto_0
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/ay;->a(Z)V
