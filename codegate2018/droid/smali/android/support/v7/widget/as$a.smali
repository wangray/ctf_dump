...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v3, p0, Landroid/support/v7/widget/as$a;->g:I
    ...
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/as$a;->g:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/as$a;->i:Landroid/support/v7/widget/ar;
    ...
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/as$a;->j:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/as$a;->i:Landroid/support/v7/widget/ar;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/ar;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/as$a;->j:Landroid/view/MenuItem;

    if-eqz v1, :cond_1

    iget-object v2, p0, Landroid/support/v7/widget/as$a;->i:Landroid/support/v7/widget/ar;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/as$a;->g:I
    ...
    iget v0, p0, Landroid/support/v7/widget/as$a;->h:I
...
.method public setHoverListener(Landroid/support/v7/widget/ar;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/as$a;->i:Landroid/support/v7/widget/ar;
