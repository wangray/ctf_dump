...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/as;->a:Ljava/lang/reflect/Method;
    :try_end_0
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v7/widget/ap;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method a(Landroid/content/Context;Z)Landroid/support/v7/widget/ai;
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/as$a;-><init>(Landroid/content/Context;Z)V

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/as$a;->setHoverListener(Landroid/support/v7/widget/ar;)V
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/ar;->a(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public a(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/as;->g:Landroid/widget/PopupWindow;
...
.method public b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/widget/ar;->b(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public c(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/as;->g:Landroid/widget/PopupWindow;
