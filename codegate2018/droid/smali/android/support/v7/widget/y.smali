...
# interfaces
.implements Landroid/support/v4/i/p;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/bi;->f(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/bi;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/bi;->d(I)Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/al;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/bi;->f(I)[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/bi;->g(II)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/al;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/y;->d:Landroid/support/v7/widget/al;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/al;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
