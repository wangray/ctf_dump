...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/ac;
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
    ...
    invoke-virtual {p2, v0, v1, v2}, Landroid/support/v7/widget/bi;->a(IILandroid/widget/TextView;)Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/z;->h:Landroid/graphics/Typeface;
    :try_end_0
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bg;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bg;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bg;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bg;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/z;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/bg;)V
...
.method a(Landroid/content/Context;I)V
    ...
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v7, p1, v3, p2, v2}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;

    move-result-object v3

    sget v4, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_textAppearance:I

    invoke-virtual {v3, v4, v9}, Landroid/support/v7/widget/bi;->g(II)I

    move-result v4

    sget v6, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v3, v6}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/bi;->g(II)I

    move-result v6

    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/m;I)Landroid/support/v7/widget/bg;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/z;->b:Landroid/support/v7/widget/bg;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->c:Landroid/support/v7/widget/bg;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/z;->d:Landroid/support/v7/widget/bg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->e:Landroid/support/v7/widget/bg;
    ...
    invoke-static {v7, v4, v0}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v9, v0}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v9, v0, v2}, Landroid/support/v7/widget/bi;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/z;->a(Landroid/content/Context;Landroid/support/v7/widget/bi;)V
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v9, v4}, Landroid/support/v7/widget/bi;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v9, v6}, Landroid/support/v7/widget/bi;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v10}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v9, v5}, Landroid/support/v7/widget/bi;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    :cond_4
    :goto_3
    invoke-virtual {v9}, Landroid/support/v7/widget/bi;->a()V

    :goto_4
    sget-object v9, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v7, p1, v9, p2, v2}, Landroid/support/v7/widget/bi;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/bi;
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/bi;->g(I)Z
    ...
    invoke-virtual {v9, v1}, Landroid/support/v7/widget/bi;->e(I)Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/ac;

    invoke-virtual {v3}, Landroid/support/v7/widget/ac;->d()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/z;->f:Landroid/support/v7/widget/ac;

    invoke-virtual {v4}, Landroid/support/v7/widget/ac;->b()I
