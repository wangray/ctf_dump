...
class s {
    ...
    private static Object a(ViewGroup viewGroup, View view, android.support.v4.h.a<String, String> aVar, a aVar2, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        View view2 = null;
        ...
        android.support.v4.h.a b = b((android.support.v4.h.a) aVar, a, aVar2);
        final android.support.v4.h.a c = c(aVar, a, aVar2);
        if (aVar.isEmpty()) {
            if (b != null) {
                b.clear();
            }
    ...
    private static void a(c cVar, a aVar, SparseArray<a> sparseArray, boolean z, boolean z2) {
        ...
        if (hVar != null) {
            ...
            if (i != 0) {
                ...
                if (!z2 && r7 != 0 && aVar2 != null && aVar2.a == hVar) {
                    aVar2.a = null;
                }
            }
        }
    ...
    private static void a(n nVar, int i, a aVar, View view, android.support.v4.h.a<String, String> aVar2) {
        ...
        if (viewGroup != null) {
            ...
            Object a = a(hVar, z);
            Object b = b(hVar2, z2);
            Object a2 = a(viewGroup, view, (android.support.v4.h.a) aVar2, aVar, arrayList2, arrayList, a, b);
        ...
        if (nVar.l >= 1 && VERSION.SDK_INT >= 21) {
            ...
            if (sparseArray.size() != 0) {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ...
                    android.support.v4.h.a a = a(keyAt, (ArrayList) arrayList, (ArrayList) arrayList2, i, i2);
    ...
    private static void a(Object obj, Object obj2, android.support.v4.h.a<String, View> aVar, boolean z, c cVar) {
    ...
    private static void a(ArrayList<View> arrayList, android.support.v4.h.a<String, View> aVar, Collection<String> collection) {
        for (int size = aVar.size() - 1; size >= 0; size--) {
            ...
            if (collection.contains(q.k(view))) {
                arrayList.add(view);
            }
        }
    }

    private static android.support.v4.h.a<String, View> b(android.support.v4.h.a<String, String> aVar, Object obj, a aVar2) {
        ...
        if (yVar != null) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                if (view == null) {
                    aVar.remove(str);
                } else if (!str.equals(q.k(view))) {
                    aVar.put(q.k(view), (String) aVar.remove(str));
                }
            }
        } else {
            aVar.a(aVar3.keySet());
    ...
    private static View b(android.support.v4.h.a<String, View> aVar, a aVar2, Object obj, boolean z) {
        c cVar = aVar2.c;
    ...
    private static Object b(ViewGroup viewGroup, View view, android.support.v4.h.a<String, String> aVar, a aVar2, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        final h hVar = aVar2.a;
        final h hVar2 = aVar2.d;
        if (hVar == null || hVar2 == null) {
            return null;
        ...
        x.a(viewGroup, new Runnable() {
            public void run() {
                android.support.v4.h.a a = s.c(aVar3, obj3, aVar4);
                if (a != null) {
    ...
    private static void b(h hVar, h hVar2, boolean z, android.support.v4.h.a<String, View> aVar, boolean z2) {
        int i = 0;
    ...
    private static void b(n nVar, int i, a aVar, View view, android.support.v4.h.a<String, String> aVar2) {
        ViewGroup viewGroup = null;
        if (nVar.n.a()) {
            viewGroup = (ViewGroup) nVar.n.a(i);
        }
    ...
    private static android.support.v4.h.a<String, View> c(android.support.v4.h.a<String, String> aVar, Object obj, a aVar2) {
        h hVar = aVar2.a;
        View i = hVar.i();
        ...
        ArrayList arrayList;
        y yVar;
        android.support.v4.h.a<String, View> aVar3 = new android.support.v4.h.a();
        t.a((Map) aVar3, i);
        c cVar = aVar2.c;
        y Q;
        if (aVar2.b) {
        ...
        if (yVar != null) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                if (i == null) {
                    str = a((android.support.v4.h.a) aVar, str);
                    if (str != null) {
                        aVar.remove(str);
                    }
                } else if (!str.equals(q.k(i))) {
                    str = a((android.support.v4.h.a) aVar, str);
                    if (str != null) {
                        aVar.put(str, q.k(i));
                    }
            ...
            a((android.support.v4.h.a) aVar, (android.support.v4.h.a) aVar3);
        }
        return aVar3;
    }
}
