...
class d extends g {
    ...
    public android.graphics.Typeface a(android.content.Context r8, android.os.CancellationSignal r9, android.support.v4.g.b.b[] r10, int r11) {
        /*
        r7 = this;
        r0 = 0;
        r1 = r10.length;
    ...
    L_0x0006:
        ...
        r1 = r1.a();	 Catch:{ IOException -> 0x0056 }
        r3 = "r";
        r3 = r2.openFileDescriptor(r1, r3, r9);	 Catch:{ IOException -> 0x0056 }
        r2 = 0;
        r1 = r7.a(r3);	 Catch:{ Throwable -> 0x0048, all -> 0x005c }
    ...
    L_0x0025:
        ...
        r5 = 0;
        r1 = super.a(r8, r4);	 Catch:{ Throwable -> 0x0068, all -> 0x009c }
    ...
    L_0x009c:
        ...
        goto L_0x006b;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.c.d.a(android.content.Context, android.os.CancellationSignal, android.support.v4.g.b$b[], int):android.graphics.Typeface");
    }
}
