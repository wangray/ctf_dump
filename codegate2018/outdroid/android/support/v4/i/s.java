...
public final class s {
    ...
    static class c {
        ...
        public boolean a(ViewParent viewParent, View view, float f, float f2) {
            return viewParent instanceof l ? ((l) viewParent).onNestedPreFling(view, f, f2) : false;
        }

        public boolean a(ViewParent viewParent, View view, float f, float f2, boolean z) {
            return viewParent instanceof l ? ((l) viewParent).onNestedFling(view, f, f2, z) : false;
        }

        public boolean a(ViewParent viewParent, View view, View view2, int i) {
            return viewParent instanceof l ? ((l) viewParent).onStartNestedScroll(view, view2, i) : false;
        }
    ...
    public static boolean a(ViewParent viewParent, View view, View view2, int i, int i2) {
        return viewParent instanceof m ? ((m) viewParent).a(view, view2, i, i2) : i2 == 0 ? a.a(viewParent, view, view2, i) : false;
    }
