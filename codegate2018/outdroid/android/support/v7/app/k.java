...
class k extends f implements android.support.v7.view.menu.h.a, Factory2 {
    ...
    class b implements android.support.v7.view.b.a {
        ...
        public void a(android.support.v7.view.b bVar) {
            ...
            if (this.a.n != null) {
                this.a.t();
                this.a.q = q.j(this.a.n).a(0.0f);
                this.a.q.a(new v(this) {
                    final /* synthetic */ b a;
    ...
    private boolean a(ViewParent viewParent) {
        ...
        while (viewParent2 != null) {
            if (viewParent2 == decorView || !(viewParent2 instanceof View) || q.w((View) viewParent2)) {
                return false;
            }
    ...
    private void d(int i) {
        this.s |= 1 << i;
        if (!this.r) {
            q.a(this.b.getDecorView(), this.H);
            this.r = true;
        }
    }
    ...
    private ViewGroup x() {
        ...
        if (obtainStyledAttributes.hasValue(j.AppCompatTheme_windowActionBar)) {
            ...
            if (this.l) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    q.a(view2, new o(this) {
                        ...
                        public x a(View view, x xVar) {
                            ...
                            int g = this.a.g(b);
                            if (b != g) {
                                xVar = xVar.a(xVar.a(), g, xVar.c(), xVar.d());
                            }
                    ...
                    ((ak) view2).setOnFitSystemWindowsListener(new android.support.v7.widget.ak.a(this) {
                        final /* synthetic */ k a;
                ...
                this.u = (ae) r0.findViewById(android.support.v7.a.a.f.decor_content_parent);
    ...
    public void a(Toolbar toolbar) {
        if (this.c instanceof Activity) {
            ...
            if (toolbar != null) {
                a oVar = new o(toolbar, ((Activity) this.c).getTitle(), this.d);
                this.f = oVar;
                this.b.setCallback(oVar.h());
            } else {
                this.f = null;
    ...
    public View b(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        return this.L.a(view, str, context, attributeSet, z, t, true, bn.a());
    }
    ...
    final boolean s() {
        return this.x && this.y != null && q.u(this.y);
    }
