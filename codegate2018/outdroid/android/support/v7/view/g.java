...
public class g extends MenuInflater {
    ...
    private class b {
        ...
        private void a(MenuItem menuItem) {
            ...
            if (this.a != null) {
                android.support.v4.i.g.a(menuItem, this.a);
            }
            android.support.v4.i.g.a(menuItem, this.C);
            android.support.v4.i.g.b(menuItem, this.D);
            android.support.v4.i.g.b(menuItem, this.p, this.q);
            android.support.v4.i.g.a(menuItem, this.r, this.s);
            if (this.F != null) {
                android.support.v4.i.g.a(menuItem, this.F);
            }
            if (this.E != null) {
                android.support.v4.i.g.a(menuItem, this.E);
            }
        }
        ...
        public void b(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(android.support.v7.a.a.j.MenuItem_iconTintMode)) {
                this.F = ah.a(obtainStyledAttributes.getInt(android.support.v7.a.a.j.MenuItem_iconTintMode, -1), this.F);
            } else {
                this.F = null;
            }
