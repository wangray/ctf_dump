...
public class ActionMenuItemView extends ab implements android.support.v7.view.menu.p.a, android.support.v7.widget.ActionMenuView.a, OnClickListener {
    j a;
    ...
    private void f() {
        ...
        if (TextUtils.isEmpty(contentDescription)) {
            ...
            bk.a(this, charSequence);
            return;
        }
        bk.a(this, contentDescription);
    }
