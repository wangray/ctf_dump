    ...
    void a(List<j> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                char alphabeticShortcut = b ? jVar.getAlphabeticShortcut() : jVar.getNumericShortcut();
                if (!(((modifiers & 69647) == ((b ? jVar.getAlphabeticModifiers() : jVar.getNumericModifiers()) & 69647) ? 1 : 0) == 0 || alphabeticShortcut == '\u0000' || ((alphabeticShortcut != keyData.meta[0] && alphabeticShortcut != keyData.meta[2] && (!b || alphabeticShortcut != '\b' || i != 67)) || !jVar.isEnabled()))) {
                    list.add(jVar);
                }
            }
        }
