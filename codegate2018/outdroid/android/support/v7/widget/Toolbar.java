...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        bi a = bi.a(getContext(), attributeSet, android.support.v7.a.a.j.Toolbar, i, 0);
    ...
    private void a(List<View> list, int i) {
        ...
        int a = android.support.v4.i.d.a(i, q.e(this));
        list.clear();
        b bVar;
        if (i2 != 0) {
    ...
    private int b(int i) {
        int e = q.e(this);
        int a = android.support.v4.i.d.a(i, e) & 7;
        switch (a) {
            case 1:
            case 3:
            case 5:
    ...
    public int getCurrentContentInsetLeft() {
        return q.e(this) == 1 ? getCurrentContentInsetEnd() : getCurrentContentInsetStart();
    }

    public int getCurrentContentInsetRight() {
        return q.e(this) == 1 ? getCurrentContentInsetStart() : getCurrentContentInsetEnd();
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!a(this.i)) {
            ...
            currentContentInsetLeft = b(this.i, i6, iArr, min);
            currentContentInsetRight = i5;
        } else {
            currentContentInsetLeft = i6;
            ...
            switch (this.x & 112) {
                ...
                default:
                    ...
                    if (paddingTop2 < bVar.topMargin + this.s) {
                        i6 = bVar.topMargin + this.s;
                    } else {
                        measuredHeight = (((height - paddingBottom) - measuredHeight) - paddingTop2) - paddingTop;
                        i6 = measuredHeight < bVar.bottomMargin + this.t ? Math.max(0, paddingTop2 - ((bVar2.bottomMargin + this.t) - measuredHeight)) : paddingTop2;
                    }
                    paddingTop2 = paddingTop + i6;
                    break;
            }
            if (obj != null) {
                i6 = (obj2 != null ? this.q : 0) - iArr[1];
