...
public class bi {
    ...
    private bi(Context context, TypedArray typedArray) {
        this.a = context;
        this.b = typedArray;
    }

    public static bi a(Context context, int i, int[] iArr) {
        return new bi(context, context.obtainStyledAttributes(i, iArr));
    }

    public static bi a(Context context, AttributeSet attributeSet, int[] iArr) {
        return new bi(context, context.obtainStyledAttributes(attributeSet, iArr));
    }
    ...
    public Drawable b(int i) {
        if (this.b.hasValue(i)) {
            int resourceId = this.b.getResourceId(i, 0);
            if (resourceId != 0) {
                return m.a().a(this.a, resourceId, true);
            }
        }
        return null;
    }
