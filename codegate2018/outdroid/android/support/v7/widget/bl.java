...
class bl implements OnAttachStateChangeListener, OnHoverListener, OnLongClickListener {
    private static bl i;
    ...
    public static void a(View view, CharSequence charSequence) {
        ...
        bl blVar = new bl(view, charSequence);
    }
    ...
    private void a(boolean z) {
        if (q.w(this.a)) {
            ...
            i = this;
            this.h = z;
            this.g = new bm(this.a.getContext());
            this.g.a(this.a, this.e, this.f, this.h, this.b);
            this.a.addOnAttachStateChangeListener(this);
            long longPressTimeout = this.h ? 2500 : (q.l(this.a) & 1) == 1 ? 3000 - ((long) ViewConfiguration.getLongPressTimeout()) : 15000 - ((long) ViewConfiguration.getLongPressTimeout());
            this.a.removeCallbacks(this.d);
