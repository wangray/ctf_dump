...
class d extends android.support.v7.view.menu.b implements android.support.v4.i.c.a {
    private b A;
    d g;
    e h;
    a i;
    ...
    public void b(boolean z) {
        ...
        if (this.c != null) {
            ...
            int size = k.size();
            for (i = 0; i < size; i++) {
                android.support.v4.i.c a = ((j) k.get(i)).a();
                if (a != null) {
                    a.a((android.support.v4.i.c.a) this);
                }
            }
        }
