...
public final class m {
    ...
    private Drawable a(Context context, int i, boolean z, Drawable drawable) {
        ...
        if (b != null) {
            ...
            a(r0.findDrawableByLayerId(16908288), bd.a(context, android.support.v7.a.a.a.colorControlNormal), a);
            a(r0.findDrawableByLayerId(16908303), bd.a(context, android.support.v7.a.a.a.colorControlNormal), a);
            a(r0.findDrawableByLayerId(16908301), bd.a(context, android.support.v7.a.a.a.colorControlActivated), a);
            return drawable;
            ...
            r0 = (LayerDrawable) drawable;
            a(r0.findDrawableByLayerId(16908288), bd.c(context, android.support.v7.a.a.a.colorControlNormal), a);
            a(r0.findDrawableByLayerId(16908303), bd.a(context, android.support.v7.a.a.a.colorControlActivated), a);
            a(r0.findDrawableByLayerId(16908301), bd.a(context, android.support.v7.a.a.a.colorControlActivated), a);
            return drawable;
        }
    }
    ...
    private android.graphics.drawable.Drawable a(android.content.Context r5, long r6) {
        ...
        r0 = (android.support.v4.h.f) r0;	 Catch:{ all -> 0x002b }
    ...
    static void a(Drawable drawable, bg bgVar, int[] iArr) {
        if (!ah.b(drawable) || drawable.mutate() == drawable) {
            if (bgVar.d || bgVar.c) {
                drawable.setColorFilter(a(bgVar.d ? bgVar.a : null, bgVar.c ? bgVar.b : a, iArr));
            } else {
    ...
    static boolean a(Context context, int i, Drawable drawable) {
        ...
        drawable.setColorFilter(a(bd.a(context, i2), mode));
        if (i3 == -1) {
            return true;
        }
    ...
    private ColorStateList b(Context context) {
        return f(context, bd.a(context, android.support.v7.a.a.a.colorButtonNormal));
    }
    ...
    private ColorStateList d(Context context) {
        return f(context, bd.a(context, android.support.v7.a.a.a.colorAccent));
    }
    ...
    L_0x0095:
        ...
        r0 = (android.support.v7.widget.m.c) r0;	 Catch:{ Exception -> 0x0082 }
    ...
    private ColorStateList e(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList b = bd.b(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
        if (b == null || !b.isStateful()) {
            iArr[0] = bd.a;
            iArr2[0] = bd.c(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
            iArr[1] = bd.e;
            iArr2[1] = bd.a(context, android.support.v7.a.a.a.colorControlActivated);
            iArr[2] = bd.h;
            iArr2[2] = bd.a(context, android.support.v7.a.a.a.colorSwitchThumbNormal);
        } else {
            iArr[0] = bd.a;
    ...
    private ColorStateList e(Context context, int i) {
        ...
        n nVar = (n) this.j.get(context);
        return nVar != null ? (ColorStateList) nVar.a(i) : null;
    }

    private ColorStateList f(Context context, int i) {
        r0 = new int[4][];
        r1 = new int[4];
        int a = bd.a(context, android.support.v7.a.a.a.colorControlHighlight);
        int c = bd.c(context, android.support.v7.a.a.a.colorButtonNormal);
        r0[0] = bd.a;
        r1[0] = c;
        r0[1] = bd.d;
    ...
    ColorStateList b(Context context, int i) {
        ...
        if (e == null) {
            if (i == e.abc_edit_text_material) {
                ...
                e = bd.b(context, android.support.v7.a.a.a.colorControlNormal);
            } else if (a(h, i)) {
