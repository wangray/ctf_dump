...
public class y extends Spinner implements p {
    ...
    private static class a implements ListAdapter, SpinnerAdapter {
        ...
        public a(SpinnerAdapter spinnerAdapter, Theme theme) {
            ...
            } else if (spinnerAdapter instanceof be) {
                be beVar = (be) spinnerAdapter;
                if (beVar.a() == null) {
                    beVar.a(theme);
                }
            }
    ...
    private class b extends ap {
        ...
        public b(final y yVar, Context context, AttributeSet attributeSet, int i) {
            this.b = yVar;
        ...
        boolean a(View view) {
            return q.w(view) && view.getGlobalVisibleRect(this.i);
        }
        ...
        void f() {
            ...
            if (h != null) {
                ...
                i = bq.a(this.b) ? this.b.i.right : -this.b.i.left;
            } else {
                Rect b = this.b.i;
                this.b.i.right = 0;
                b.left = 0;
            ...
            c(bq.a(this.b) ? ((width - paddingRight) - l()) + i : i + paddingLeft);
        }
    }
    ...
    public y(Context context, AttributeSet attributeSet, int i, int i2, Theme theme) {
        ...
        super(context, attributeSet, i);
        this.i = new Rect();
        bi a2 = bi.a(context, attributeSet, j.Spinner, i, 0);
        this.b = new h(this);
        if (theme != null) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == 1) {
                                    ...
                                    a = bi.a(this.c, attributeSet, j.Spinner, i, 0);
